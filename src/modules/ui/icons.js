...
const P = {
  ...
  grass: '<path d="M4 20h16M6 20c0-4-1-7-2.5-9M9 20c0-5 .5-9 2-12M12.5 20c0-4 1-8 3.5-11M16 20c.5-3 2-5.5 4-7"/>',
  shrub: '<path d="M12 20v-4M5.5 16a3.5 3.5 0 0 1 1-6.8 4.5 4.5 0 0 1 8.3-2 3.8 3.8 0 0 1 3.7 6 3 3 0 0 1-1.5 2.8z"/>',
  tree: '<path d="M12 20v-9M12 11l-3-2.5M12 13l3.5-3"/><path d="M3 8.5c2-2.5 5.5-3.5 9-3.5s7 1 9 3.5c-2.5 1-5.5 1.5-9 1.5s-6.5-.5-9-1.5z"/>',
