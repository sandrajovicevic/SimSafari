...
| blind4-sav-waterhole | 8.0 | 8.0 | Still the strongest single image — elephants and zebras at the pan, detailed acacia crown, kopje backdrop. The "clumpy leaf-puffs" and "blue-tipped grass" nits from round 3 are not visible this round. **New/carried-over defect**: a hard-edged black patch sits in the pan centre under the tree canopy — was in round 3's shot too but never filed as its own issue; filed now under savannah's STATUS entry. |
